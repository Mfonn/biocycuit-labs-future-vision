...
const sections = [
  ...
  },
  {
    ...
    content: [
      ...
      "Earth building traditions also incorporated biological additives: cow dung mixed into plaster provides natural waterproofing due to its lipid content, shea butter was applied to surfaces for moisture resistance, and fermented locust bean (dawadawa) was mixed into adobe for increased binding strength. This was an early form of bio-composite engineering.",
      "Our consulting practice helps architects integrate these principles with modern biotechnology: bio-cemented rammed earth (using microbially induced calcite precipitation, or MICP), self-healing concrete inoculated with Bacillus bacteria that precipitate limestone when cracks expose them to water, and mycelium-based insulation panels grown from agricultural waste.",
    ],
  },
  {
      ...
      <section className="py-16 px-6 border-t border-border/50">
        <div className="max-w-3xl mx-auto text-center">
          ...
          <div className="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a href="mailto:Biocircuitlaboratories@gmail.com?subject=Architecture Consulting" className="px-8 py-4 rounded-lg font-display text-sm tracking-wider uppercase bg-primary text-primary-foreground hover:shadow-[0_0_30px_hsl(var(--primary)/0.4)] transition-shadow duration-500">Start a Conversation</a>
